...
$token = bin2hex(random_bytes(50));
 ...
 { 
$FromName="Host Tales";
$FromEmail="pranshupatle25@gmail.com";
$ReplyTo="pranjalpatle4@gmail.com";
$credits="All rights are reserved | Host Tales "; 
$headers  = "MIME-Version: 1.0\n";
     ...
     $msg="Your password reset link <br> http://localhost/form/password-reset.php?token=".$token." <br> Reset your password with this link .Click or open in new tab<br><br> <br> <br> <center>".$credits."</center>"; 
